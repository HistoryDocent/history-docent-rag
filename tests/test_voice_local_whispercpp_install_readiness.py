...
DOC_PATH = Path("docs/VOICE_LOCAL_WHISPERCPP_INSTALL_READINESS.md")
REPORT_PATH = Path("evals/reports/voice_local_whispercpp_install_readiness_report.md")
README_PATH = Path("README.md")

REQUIRED_README_LINKS = (
    "docs/VOICE_LOCAL_WHISPERCPP_INSTALL_READINESS.md",
    "evals/reports/voice_local_whispercpp_install_readiness_report.md",
)
...
PUBLIC_SCAN_PATHS = (
    ...
    DOC_PATH,
    REPORT_PATH,
    Path("docs/VOICE_LOCAL_WHISPERCPP_INSTALL_APPROVAL.md"),
...
def test_whispercpp_install_readiness_docs_exist_and_are_sanitized() -> None:
...
def test_whispercpp_install_readiness_readme_links_exist() -> None:
...
def test_whispercpp_install_readiness_records_blocked_source_build_metrics() -> None:
    ...
    assert "fact_voice_local_whispercpp_install_readiness" in report


def test_whispercpp_install_readiness_keeps_forbidden_claims_forbidden() -> None:
    doc = DOC_PATH.read_text(encoding="utf-8")
    report = REPORT_PATH.read_text(encoding="utf-8")
