...
DOC_PATH = Path("docs/GITHUB_PUSH_READINESS.md")
REPORT_PATH = Path("evals/reports/github_push_readiness_report.md")
README_PATH = Path("README.md")

REQUIRED_README_LINKS = (
    "docs/GITHUB_PUSH_READINESS.md",
    "evals/reports/github_push_readiness_report.md",
)
...
PUBLIC_SCAN_PATHS = (
    ...
    DOC_PATH,
    REPORT_PATH,
    Path("docs/DEMO_RECORDING_CHECKLIST.md"),
...
def test_github_push_readiness_docs_exist_and_are_sanitized() -> None:
...
def test_github_push_readiness_readme_links_exist() -> None:
...
def test_github_push_readiness_records_git_preflight() -> None:
...
def test_github_push_readiness_keeps_forbidden_claims_as_forbidden() -> None:
    doc = DOC_PATH.read_text(encoding="utf-8")
...
def test_github_push_readiness_report_records_gates() -> None:
    report = REPORT_PATH.read_text(encoding="utf-8")
    ...
    assert "fact_github_push_readiness" in report
