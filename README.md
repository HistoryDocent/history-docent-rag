...
| voice STT/TTS managed provider smoke approval | `HD-VOICE-STT-TTS-PROVIDER-BENCH-MANAGED-SMOKE-APPROVAL-001` | approval-only | managed_provider_execution_approved / managed_provider_api_call_count / external_audio_transmission_count | false / 0 / 0 | ready for separate managed smoke approval |
| voice STT/TTS managed provider smoke execution harness | `HD-VOICE-STT-TTS-PROVIDER-BENCH-MANAGED-SMOKE-EXECUTION-HARNESS-001` | dry-run harness-only | dry_run_default / call_cap_enforced / managed_provider_api_call_count | true / true / 0 | ready for separate managed smoke execution |
...
| voice STT/TTS Azure managed smoke readiness | `HD-VOICE-STT-TTS-AZURE-MANAGED-SMOKE-READINESS-001` | readiness-only | first_managed_provider_candidate / planned_stt_call_count / managed_provider_api_call_count | managed_azure_ai_speech / 3 / 0 | ready for Azure credential setup |
