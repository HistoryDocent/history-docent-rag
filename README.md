...
`data_manifest`와 `normalized_blocks` schema를 고정했고, parser normalization pipeline도 통과했다.

다음 단계는 parser quality report와 normalized block validation notebook 작성이다.
