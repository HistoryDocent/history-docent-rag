...
| voice provider 전략 | 무료 로컬 STT/TTS 우선. STT는 `faster-whisper small CUDA`를 현재 demo evidence 기준 primary 후보로 고정했다. TTS는 `sherpa-onnx` Supertonic 3 Korean 자동 proxy 4/5와 사람 청취 점수 30/30 평균 5.0으로 demo review 후보로 수락했다. 다만 production final provider와 실제 관광객 품질 검증은 아직 확정하지 않는다. Azure/Google/AWS는 optional paid comparison only |
...
| portfolio final package index | `HD-PORTFOLIO-FINAL-PACKAGE-INDEX-001` | submission package navigation | first_open_artifact_count / evidence_family_count / production_success_claim_count | 8 / 6 / 0 | final package index passed |
...
| voice STT/TTS provider benchmark local smoke | `HD-VOICE-STT-TTS-PROVIDER-BENCH-SMOKE-LOCAL-001` | local-cuda-smoke-only | resolved_device / local_stt_execution_count / external_provider_call_count | cuda / 5 / 0 | local STT smoke completed |
...
| voice STT/TTS managed provider smoke approval | `HD-VOICE-STT-TTS-PROVIDER-BENCH-MANAGED-SMOKE-APPROVAL-001` | approval-only | managed_provider_execution_approved / managed_provider_api_call_count / external_audio_transmission_count | false / 0 / 0 | optional paid comparison only |
| voice STT/TTS managed provider smoke execution harness | `HD-VOICE-STT-TTS-PROVIDER-BENCH-MANAGED-SMOKE-EXECUTION-HARNESS-001` | dry-run harness-only | dry_run_default / call_cap_enforced / managed_provider_api_call_count | true / true / 0 | optional paid comparison only |
| voice STT/TTS managed provider smoke preflight | `HD-VOICE-STT-TTS-PROVIDER-BENCH-MANAGED-SMOKE-PREFLIGHT-001` | preflight-only | executable_provider_candidate_count / recommended_first_provider_count / managed_provider_api_call_count | 0 / 0 / 0 | credential setup before selected managed smoke |
| voice STT/TTS managed provider smoke execution gate | `HD-VOICE-STT-TTS-PROVIDER-BENCH-MANAGED-SMOKE-001` | execution-gate | azure_credential_ready / managed_provider_execution_approved / managed_provider_api_call_count | false / false / 0 | blocked missing Azure credentials |
| voice STT/TTS Azure managed smoke readiness | `HD-VOICE-STT-TTS-AZURE-MANAGED-SMOKE-READINESS-001` | readiness-only | first_managed_provider_candidate / planned_stt_call_count / managed_provider_api_call_count | managed_azure_ai_speech / 3 / 0 | optional paid comparison only |
| voice STT/TTS Azure credential preflight | `HD-VOICE-STT-TTS-AZURE-CREDENTIAL-PREFLIGHT-001` | preflight-only | azure_credential_ready / credential_present_count / managed_provider_api_call_count | false / 0 / 0 | blocked missing Azure credentials |
| voice STT/TTS Azure smoke execution approval | `HD-VOICE-STT-TTS-AZURE-SMOKE-EXECUTION-APPROVAL-001` | approval-only | azure_smoke_execution_approved / managed_provider_api_call_count / external_audio_transmission_count | false / 0 / 0 | blocked missing Azure credentials |
...
| voice local runtime matrix | `HD-VOICE-STT-TTS-LOCAL-RUNTIME-MATRIX-001` | runtime-preflight-only | runtime_candidate_count / import_available_candidate_count / tts_runtime_available_count | 5 / 1 / 0 | historical runtime preflight, TTS runtime unavailable at that gate |
...
| voice local whisper.cpp install readiness | `HD-VOICE-LOCAL-WHISPERCPP-INSTALL-READINESS-001` | local STT install readiness | available_tool_command_count / missing_build_tool_command_count / cuda_gpu_detected_count | 3 / 4 / 1 | source build toolchain blocked |
...
| voice local TTS quality listening review | `HD-VOICE-LOCAL-TTS-QUALITY-LISTENING-REVIEW-001` | local TTS quality review harness | audio_file_available_count / automated_metric_pass_count / human_listening_completed_count / external_provider_call_count | 5 / 5 / 0 / 0 | historical rubric gate before human score entry |
| voice local TTS human score fill | `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-FILL-001` | private human score template + public aggregate | private_template_row_count / completed_score_row_count / aggregate_public_row_count / external_provider_call_count | 30 / 30 / 6 / 0 | human scores aggregated, pending provider decision |
| voice local TTS human score collection | `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-COLLECTION-001` | private listening manifest + public aggregate gate | private_audio_available_count / private_listening_manifest_row_count / completed_score_row_count / external_provider_call_count | 5 / 5 / 30 / 0 | human scores collected |
| voice local TTS human score entry | `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-ENTRY-001` | private score entry tool + public aggregate gate | private_score_entry_draft_row_count / completed_score_row_count / aggregate_public_row_count / external_provider_call_count | 30 / 30 / 6 / 0 | human scores entered |
| voice local TTS human score entry completion | `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-ENTRY-COMPLETION-001` | private score completion verification + public aggregate gate | completed_score_row_count / pending_score_row_count / aggregate_public_row_count / external_provider_call_count | 30 / 0 / 6 / 0 | completed scores ready for provider decision |
| voice local TTS human score manual scoring workspace | `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-MANUAL-SCORING-001` | private HTML score sheet + public aggregate gate | private_manual_score_sheet_created_count / completed_score_row_count / pending_score_row_count / external_provider_call_count | 1 / 30 / 0 / 0 | human manual scores completed |
| voice local TTS human score decision | `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-DECISION-001` | human score provider decision gate | completed_score_row_count / provider_decision / external_provider_call_count | 30 / candidate_accepted_for_demo_review / 0 | demo review candidate accepted |
| voice local TTS human score manual scoring runbook | `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-MANUAL-SCORING-RUNBOOK-001` | manual scoring execution runbook | private_manual_score_sheet_available_count / completed_score_row_count / user_action_required_count / external_provider_call_count | 1 / 30 / 0 / 0 | completed scores ready for decision |
| voice local TTS automated proxy eval | `HD-VOICE-LOCAL-TTS-AUTOMATED-PROXY-EVAL-001` | local STT round-trip proxy | local_stt_execution_count / proxy_metric_pass_count / human_listening_completed_count / external_provider_call_count | 5 / 4 / 0 / 0 | proxy threshold failed, human score decision handled separately |
| voice local free stack lock | `HD-VOICE-LOCAL-FREE-STACK-LOCK-001` | local-free voice contract decision | primary_local_stt_candidate_count / primary_local_tts_candidate_count / external_provider_call_count | 1 / 0 / 0 | historical stack lock before human score decision |
...
| GitHub push execution approval | `HD-GITHUB-PUSH-EXECUTION-APPROVAL-001` | push approval gate | explicit_push_approval_count / push_command_execution_count / external_state_change_count | 0 / 0 / 0 | explicit approval required, push not executed |
...
무료 로컬 whisper.cpp 설치 readiness 결과는 [Voice Local whisper.cpp Install Readiness](docs/VOICE_LOCAL_WHISPERCPP_INSTALL_READINESS.md), [Voice Local whisper.cpp Install Readiness Report](evals/reports/voice_local_whispercpp_install_readiness_report.md)를 기준으로 한다.
...
무료 로컬 sherpa-onnx Supertonic 3 Korean TTS smoke 결과는 [Voice Local Sherpa-ONNX Supertonic 3 Korean TTS Smoke](docs/VOICE_LOCAL_SHERPA_ONNX_SUPERTONIC3_KO_SMOKE.md), [Voice Local Sherpa-ONNX Supertonic 3 Korean TTS Smoke Report](evals/reports/voice_local_sherpa_onnx_supertonic3_ko_smoke_report.md)를 기준으로 한다.
...
GitHub push 실행 승인 경계는 [GitHub Push Execution Approval](docs/GITHUB_PUSH_EXECUTION_APPROVAL.md), [GitHub Push Execution Approval Report](evals/reports/github_push_execution_approval_report.md)를 기준으로 한다.
...
`place_story` targeted chunk audit을 실행했다. `q-dev-place-story-001`의 target child와 parent는 chunk artifact에 모두 존재하고 citation ref도 유지되어 `chunk_generation_loss_count=0`, `chunk_boundary_defect_count=0`, `reopen_global_chunking_count=0`으로 기록했다. 결론은 전체 청킹 재실험을 열지 않고 HyDE/retrieval 실험으로 넘기는 것이다.

HyDE subset readiness dry-run을 실행했다. dev subset 5개에서 answerable 4개만 HyDE live 비교 후보로 두고, `no_answer` 1개는 hallucination guard로 HyDE generation을 차단했다. readiness 단계의 Solar Pro 3 호출은 0회이고, 다음 live 비교 예상 호출 수는 4회다. 이 결과는 HyDE 성능 개선 주장이 아니라 `HD-HYDE-001B` 실행 전 subset, call budget, no-answer guard 고정 결과다.
...
HyDE larger dev subset readiness를 실행했다. dev 70개 중 `overview`, `place_story`, `relationship`, `no_answer` 4개 query type을 각 10개씩 고정해 총 40개를 다음 비교 대상으로 잡았다. 예상 Solar Pro 3 HyDE generation 호출은 answerable 30회이고, `no_answer` 10개는 generation과 retrieval 후보에서 차단했다. readiness 단계의 실제 Solar Pro 3 호출은 0회였고, 후속 `HD-HYDE-001D` live paired comparison에서 기본 route 채택 여부를 검증했다.
...
Locked retrieval 검증 승인 계획, readiness dry-run runner, execution approval, paired comparison runner를 추가했다. locked test 35개에서 `dense_multilingual_e5_small_voice_rewrite`와 `relationship_hybrid_weighted_e5_v1`를 사전 승인된 조건으로만 비교했다. 결과는 relationship subset 5개 기준 `Recall@5 delta=0.000000`, `MRR delta=-0.100000`, `nDCG@5 delta=-0.073814`, `latency_p95_ms delta=7.370080`, bootstrap 10000회 95% CI `[-0.300000, 0.000000]`로 `keep_shadow_without_locked_improvement_claim`이다. 이 결과로 active route default enable 또는 production 개선을 주장하지 않는다.
...
| [API Response Sample](docs/API_RESPONSE_SAMPLE.md) | HD-API-SAMPLE-001 `/api/v1/chat` answer, spoken answer, citation, dry-run route 응답 예시 |
...
| [GitHub Push Execution Approval](docs/GITHUB_PUSH_EXECUTION_APPROVAL.md) | HD-GITHUB-PUSH-EXECUTION-APPROVAL-001 실제 push 실행 명시 승인 gate |
| [GitHub Push Execution Approval Report](evals/reports/github_push_execution_approval_report.md) | HD-GITHUB-PUSH-EXECUTION-APPROVAL-001 정량/정성 push approval 검증 |
...
| [Voice Demo Stack Decision](docs/VOICE_DEMO_STACK_DECISION.md) | HD-VOICE-DEMO-STACK-DECISION-001 무료 로컬 음성 데모 스택과 claim boundary |
...
| [Voice Local whisper.cpp Deployment Smoke](docs/VOICE_LOCAL_WHISPERCPP_DEPLOYMENT_SMOKE.md) | HD-VOICE-LOCAL-WHISPERCPP-DEPLOYMENT-SMOKE-001 whisper.cpp local STT runtime/model 배포성 smoke와 blocker 기록 |
| [Voice Local whisper.cpp Deployment Smoke Report](evals/reports/voice_local_whispercpp_deployment_smoke_report.md) | HD-VOICE-LOCAL-WHISPERCPP-DEPLOYMENT-SMOKE-001 정량/정성 whisper.cpp deployment smoke와 zero external call 검증 |
...
| [Voice Local Sherpa-ONNX Supertonic 3 Korean TTS Smoke](docs/VOICE_LOCAL_SHERPA_ONNX_SUPERTONIC3_KO_SMOKE.md) | HD-VOICE-LOCAL-SHERPA-ONNX-SUPERTONIC3-KO-SMOKE-001 sherpa-onnx Supertonic 3 Korean local TTS private wav smoke |
| [Voice Local Sherpa-ONNX Supertonic 3 Korean TTS Smoke Report](evals/reports/voice_local_sherpa_onnx_supertonic3_ko_smoke_report.md) | HD-VOICE-LOCAL-SHERPA-ONNX-SUPERTONIC3-KO-SMOKE-001 정량/정성 local Korean TTS smoke와 zero external call 검증 |
| [Voice Local TTS Quality Listening Review](docs/VOICE_LOCAL_TTS_QUALITY_LISTENING_REVIEW.md) | HD-VOICE-LOCAL-TTS-QUALITY-LISTENING-REVIEW-001 sherpa-onnx private wav 5개 자동 metric과 사람 청취 rubric |
| [Voice Local TTS Quality Listening Review Report](evals/reports/voice_local_tts_quality_listening_review_report.md) | HD-VOICE-LOCAL-TTS-QUALITY-LISTENING-REVIEW-001 정량/정성 local TTS quality review harness와 human rubric |
...
| [Voice Local TTS Human Score Fill Report](evals/reports/voice_local_tts_human_score_fill_report.md) | HD-VOICE-LOCAL-TTS-HUMAN-SCORE-FILL-001 정량/정성 human score fill gate와 completed aggregate |
...
| [Voice Local TTS Human Score Collection Report](evals/reports/voice_local_tts_human_score_collection_report.md) | HD-VOICE-LOCAL-TTS-HUMAN-SCORE-COLLECTION-001 정량/정성 collection gate와 completed private scores aggregate |
...
| [Voice Local TTS Human Score Entry Report](evals/reports/voice_local_tts_human_score_entry_report.md) | HD-VOICE-LOCAL-TTS-HUMAN-SCORE-ENTRY-001 정량/정성 entry gate와 completed manual scores aggregate |
...
| [Voice Local TTS Human Score Entry Completion Report](evals/reports/voice_local_tts_human_score_entry_completion_report.md) | HD-VOICE-LOCAL-TTS-HUMAN-SCORE-ENTRY-COMPLETION-001 정량/정성 completion gate와 completed human scores |
...
| [Voice Local TTS Human Score Manual Scoring Report](evals/reports/voice_local_tts_human_score_manual_scoring_report.md) | HD-VOICE-LOCAL-TTS-HUMAN-SCORE-MANUAL-SCORING-001 정량/정성 manual scoring workspace gate와 completed human scores |
...
| [Voice Local TTS Human Score Manual Scoring Runbook Report](evals/reports/voice_local_tts_human_score_manual_scoring_runbook_report.md) | HD-VOICE-LOCAL-TTS-HUMAN-SCORE-MANUAL-SCORING-RUNBOOK-001 정량/정성 runbook completion과 zero external call 검증 |
...
| [Voice STT/TTS Managed Provider Smoke Approval](docs/VOICE_STT_TTS_MANAGED_PROVIDER_SMOKE_APPROVAL.md) | HD-VOICE-STT-TTS-PROVIDER-BENCH-MANAGED-SMOKE-APPROVAL-001 managed provider smoke 실행 전 source recheck, call cap, privacy, public artifact 경계 고정 |
| [Voice STT/TTS Managed Provider Smoke Approval Report](evals/reports/voice_stt_tts_managed_provider_smoke_approval_report.md) | HD-VOICE-STT-TTS-PROVIDER-BENCH-MANAGED-SMOKE-APPROVAL-001 정량/정성 approval-only gate와 zero external call 검증 |
| [Voice STT/TTS Managed Provider Smoke Execution Harness](docs/VOICE_STT_TTS_MANAGED_PROVIDER_SMOKE_EXECUTION_HARNESS.md) | HD-VOICE-STT-TTS-PROVIDER-BENCH-MANAGED-SMOKE-EXECUTION-HARNESS-001 managed provider 실제 호출 전 dry-run runner, call cap, credential preflight, public-safe report |
| [Voice STT/TTS Managed Provider Smoke Execution Harness Report](evals/reports/voice_stt_tts_managed_provider_smoke_execution_harness_report.md) | HD-VOICE-STT-TTS-PROVIDER-BENCH-MANAGED-SMOKE-EXECUTION-HARNESS-001 정량/정성 dry-run harness gate와 zero external call 검증 |
| [Voice STT/TTS Managed Provider Smoke Preflight](docs/VOICE_STT_TTS_MANAGED_PROVIDER_SMOKE_PREFLIGHT.md) | HD-VOICE-STT-TTS-PROVIDER-BENCH-MANAGED-SMOKE-PREFLIGHT-001 managed provider 실제 호출 직전 credential, source, region, retention, cost preflight |
| [Voice STT/TTS Managed Provider Smoke Preflight Report](evals/reports/voice_stt_tts_managed_provider_smoke_preflight_report.md) | HD-VOICE-STT-TTS-PROVIDER-BENCH-MANAGED-SMOKE-PREFLIGHT-001 정량/정성 preflight gate와 zero external call 검증 |
| [Voice STT/TTS Managed Provider Smoke Execution](docs/VOICE_STT_TTS_MANAGED_PROVIDER_SMOKE_EXECUTION.md) | HD-VOICE-STT-TTS-PROVIDER-BENCH-MANAGED-SMOKE-001 selected managed provider smoke execution gate와 차단 조건 |
| [Voice STT/TTS Managed Provider Smoke Execution Report](evals/reports/voice_stt_tts_managed_provider_smoke_execution_report.md) | HD-VOICE-STT-TTS-PROVIDER-BENCH-MANAGED-SMOKE-001 정량/정성 execution gate와 zero external call 검증 |
| [Voice STT/TTS Azure Managed Smoke Readiness](docs/VOICE_STT_TTS_AZURE_MANAGED_SMOKE_READINESS.md) | HD-VOICE-STT-TTS-AZURE-MANAGED-SMOKE-READINESS-001 Azure first managed smoke 후보, source/region/retention/cost 재확인, zero-call readiness |
| [Voice STT/TTS Azure Managed Smoke Readiness Report](evals/reports/voice_stt_tts_azure_managed_smoke_readiness_report.md) | HD-VOICE-STT-TTS-AZURE-MANAGED-SMOKE-READINESS-001 정량/정성 readiness gate와 zero external call 검증 |
| [Voice STT/TTS Azure Credential Preflight](docs/VOICE_STT_TTS_AZURE_CREDENTIAL_PREFLIGHT.md) | HD-VOICE-STT-TTS-AZURE-CREDENTIAL-PREFLIGHT-001 Azure credential 존재 여부, source 재확인 조건, zero-call preflight |
| [Voice STT/TTS Azure Credential Preflight Report](evals/reports/voice_stt_tts_azure_credential_preflight_report.md) | HD-VOICE-STT-TTS-AZURE-CREDENTIAL-PREFLIGHT-001 정량/정성 credential preflight와 zero external call 검증 |
| [Voice STT/TTS Azure Smoke Execution Approval](docs/VOICE_STT_TTS_AZURE_SMOKE_EXECUTION_APPROVAL.md) | HD-VOICE-STT-TTS-AZURE-SMOKE-EXECUTION-APPROVAL-001 Azure smoke 실행 전 credential, source, region, retention, cost 승인 gate |
| [Voice STT/TTS Azure Smoke Execution Approval Report](evals/reports/voice_stt_tts_azure_smoke_execution_approval_report.md) | HD-VOICE-STT-TTS-AZURE-SMOKE-EXECUTION-APPROVAL-001 정량/정성 approval-only gate와 zero external call 검증 |
| [Voice STT/TTS Azure Smoke Execution](docs/VOICE_STT_TTS_AZURE_SMOKE_EXECUTION.md) | HD-VOICE-STT-TTS-AZURE-SMOKE-EXECUTION-001 Azure smoke 실행 runner와 차단 gate |
| [Voice STT/TTS Azure Smoke Execution Report](evals/reports/voice_stt_tts_azure_smoke_execution_report.md) | HD-VOICE-STT-TTS-AZURE-SMOKE-EXECUTION-001 정량/정성 execution gate와 zero external call 검증 |
| [Voice STT/TTS Azure Credential Ready Smoke Approval](docs/VOICE_STT_TTS_AZURE_CREDENTIAL_READY_AND_SMOKE_APPROVAL.md) | HD-VOICE-STT-TTS-AZURE-CREDENTIAL-READY-AND-SMOKE-APPROVAL-001 Azure credential ready와 smoke approval 최종 zero-call gate |
| [Voice STT/TTS Azure Credential Ready Smoke Approval Report](evals/reports/voice_stt_tts_azure_credential_ready_and_smoke_approval_report.md) | HD-VOICE-STT-TTS-AZURE-CREDENTIAL-READY-AND-SMOKE-APPROVAL-001 정량/정성 approval gate와 zero external call 검증 |
...
| [Place Story Targeted Chunk Audit](docs/PLACE_STORY_TARGETED_CHUNK_AUDIT.md) | HD-CHUNK-AUDIT-001 `place_story` 1건 child/parent chunk 존재와 전역 재청킹 보류 판단 |
| [Place Story Targeted Chunk Audit Report](evals/reports/place_story_targeted_chunk_audit_report.md) | HD-CHUNK-AUDIT-001 정량/정성 targeted audit report와 public-safe gate 결과 |
| [HyDE Subset Readiness](docs/HYDE_SUBSET_READINESS.md) | HD-HYDE-001A live HyDE 비교 전 subset, call budget, no-answer guard 고정 |
...
| [Locked Retrieval Execution Approval](docs/LOCKED_RETRIEVAL_EXECUTION_APPROVAL.md) | HD-LOCKED-RETRIEVAL-003 paired comparison 실행 전 bootstrap, CI, stop condition, data mart grain |
| [Locked Retrieval Execution Approval Report](evals/reports/locked_retrieval_execution_approval_report.md) | HD-LOCKED-RETRIEVAL-003 정량/정성 승인 리포트와 public-safe gate 결과 |
| [Locked Retrieval Paired Comparison](docs/LOCKED_RETRIEVAL_PAIRED_COMPARISON.md) | HD-LOCKED-RETRIEVAL-004 locked retrieval paired comparison 결과와 claim boundary |
| [Locked Retrieval Paired Comparison Report](evals/reports/locked_retrieval_paired_comparison_report.md) | HD-LOCKED-RETRIEVAL-004 정량/정성 locked retrieval 결과와 public-safe gate |
