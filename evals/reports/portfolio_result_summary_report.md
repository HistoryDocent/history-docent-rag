...
| metric | value |
| --- | ---: |
| summarized_stage_count | 17 |
| adopted_or_implemented_count | 7 |
...
- `router_message`: query type classifier baseline, router skeleton, API dry-run, relationship guard는 구현됐지만 production routing과 locked 성능 개선은 아직 없다.
