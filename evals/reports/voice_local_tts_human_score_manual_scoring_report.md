...
| manual_scoring_id | `voice-local-tts-human-manual-scoring-s5-2fcc815a` |
...
| generated_at_utc | `2026-05-21T07:03:15+00:00` |
...
| source_fingerprint | `ac1671ce3e5174e5` |
| manual_scoring_status | `ready_for_human_manual_scoring` |
...
tts_human_manual_scoring_blockers=['awaiting_human_manual_scoring', 'incomplete_human_score_rows']
```
...
| decision | ready_for_human_manual_scoring |
