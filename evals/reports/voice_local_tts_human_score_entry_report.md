...
| score_entry_id | `voice-local-tts-human-score-entry-s5-92ab5d15` |
...
| source_fingerprint | `7fdd8de8e74364a6` |
| score_entry_status | `human_scores_entered_pending_provider_decision` |
...
| score_entry_decision | `human_scores_entered_pending_provider_decision` |
...
| score_status | 사람 청취 점수 30건이 입력됐고 entry aggregate는 provider decision gate 입력으로 사용할 수 있다. |
...
| decision | human_scores_entered_pending_provider_decision |
