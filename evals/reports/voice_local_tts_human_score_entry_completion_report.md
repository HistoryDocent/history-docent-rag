...
| score_completion_id | `voice-local-tts-human-score-completion-s5-5101244b` |
...
| source_fingerprint | `3fd062c8468935fb` |
| score_completion_status | `completed_human_scores_ready_for_provider_decision` |
...
tts_human_score_completion_blockers=[]
```
...
| decision | completed_human_scores_ready_for_provider_decision |
