...
| ---: | --- | --- | --- | --- |
| 1 | `HD-VOICE-STT-TTS-CONTRACT-001` | optional voice STT/TTS contract skeleton | STT/TTS planning gate는 완료됐다. 후속 구현은 provider 호출 없이 adapter/interface와 fallback contract만 검증해야 한다. | 예 |
