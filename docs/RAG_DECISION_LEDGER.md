...
| `portfolio_summary` | `HD-PORTFOLIO-001` | public README/docs summary | summarized_stage_count=25, leakage_count=0 | implemented | public-safe-summary | `evals/reports/portfolio_result_summary_report.md` |
...
| ---: | --- | --- | --- | --- |
| 1 | `HD-API-ROUTER-004` | active route shadow evaluation runner | active routing은 아직 미적용이며 relationship route 후보를 dev 70에서 paired 검증해야 한다. | 예 |
| 2 | `HD-LOCKED-RETRIEVAL-001` | locked test 최종 retrieval candidate 검증 계획 | shadow eval 통과 후 locked split 사용 기준이 필요하다. | 예 |
