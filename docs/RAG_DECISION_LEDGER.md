...
| ---: | --- | --- | --- | --- |
| 1 | `HD-GITHUB-PUSH-READINESS-001` | GitHub push readiness | 실제 push 전 remote, branch, commit 범위, secret scan, private/large artifact 추적 여부를 재확인한다. | 예 |
