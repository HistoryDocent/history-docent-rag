...
| ---: | --- | --- | --- | --- |
| 1 | `HD-SUBMISSION-REFRESH-AUDIT-V2-001` | public repository audit refresh v2 | demo runbook이 최신 voice route smoke 기준으로 바뀌었으므로 README 링크, 금지 claim, public-safe scan을 제출 직전 기준으로 재검증해야 한다. | 예 |
