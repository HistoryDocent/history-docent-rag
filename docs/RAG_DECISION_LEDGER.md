...
| ---: | --- | --- | --- | --- |
| 1 | `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-ENTRY-COMPLETION-001` | optional human TTS listening score entry completion | entry tool은 준비됐지만 실제 사람이 청취 후 점수를 입력하지 않았다. | 예 |
