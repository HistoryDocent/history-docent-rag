...
| ---: | --- | --- | --- | --- |
| 1 | `HD-VOICE-DEMO-RUNBOOK-REFRESH-001` | portfolio demo runbook refresh | local voice API route smoke까지 완료됐으므로 제출용 demo 순서와 allowed/forbidden claim을 최신화해야 한다. | 예 |
