...
| ---: | --- | --- | --- | --- |
| 1 | `HD-VOICE-DEMO-PLAYBACK-SMOKE-001` | local voice demo playback smoke | STT/TTS demo 후보는 정리됐지만 한 흐름의 playback smoke는 아직 별도 gate로 고정하지 않았다. | 예 |
