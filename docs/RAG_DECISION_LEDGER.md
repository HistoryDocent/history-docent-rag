...
| ---: | --- | --- | --- | --- |
| 1 | `HD-SUBMISSION-REFRESH-001` | public repository audit refresh | 제출 직전 README 링크, runbook, screenshot artifact, 금지 claim, public-safe scan을 마지막으로 재검증해야 한다. | 예 |
