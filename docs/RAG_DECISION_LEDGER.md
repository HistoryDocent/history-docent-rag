...
| ---: | --- | --- | --- | --- |
| 1 | `HD-PORTFOLIO-WALKTHROUGH-SCRIPT-001` | portfolio walkthrough script | README와 final package index가 정리됐으므로 면접 또는 화면 녹화용 3분 설명 순서를 고정할 수 있다. | 예 |
