...
| ---: | --- | --- | --- | --- |
| 1 | `HD-DEMO-RECORDING-CHECKLIST-001` | demo recording checklist | walkthrough script가 고정됐으므로 실제 녹화 전 화면, 터미널 출력, 금지 claim, raw artifact 노출 여부를 점검할 수 있다. | 예 |
