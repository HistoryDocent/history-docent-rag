...
| ---: | --- | --- | --- | --- |
| 1 | `HD-GITHUB-PUSH-EXECUTION-APPROVAL-001` | GitHub push execution approval | readiness는 통과했지만 외부 상태 변경인 push는 별도 명시 승인이 필요하다. | 예 |
