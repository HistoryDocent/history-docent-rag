...
| ---: | --- | --- | --- | --- |
| 1 | `HD-VOICE-STT-TTS-PROVIDER-BENCH-SMOKE-EXECUTION-001` | optional voice STT/TTS provider benchmark smoke execution | approval gate는 완료됐다. 실제 provider 호출은 low-risk/local 후보부터 최소 call cap으로 별도 승인 후 진행한다. | 예 |
