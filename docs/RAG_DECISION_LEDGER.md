...
| `voice_local_tts_human_score_fill` | `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-FILL-001` | private human score template + public aggregate, 5 scripts x 6 criteria | private_template_row_count=30, completed_score_row_count=0, aggregate_public_row_count=6, external_provider_call_count=0 | pending_private_human_scores | human-score-framework-only | `docs/VOICE_LOCAL_TTS_HUMAN_SCORE_FILL.md`, `evals/reports/voice_local_tts_human_score_fill_report.md` |
| `voice_local_tts_human_score_collection` | `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-COLLECTION-001` | private listening manifest + guide, 5 scripts x 6 criteria | private_audio_available_count=5, private_listening_manifest_row_count=5, completed_score_row_count=0, external_provider_call_count=0 | ready_for_private_human_collection | human-score-collection-workflow-only | `docs/VOICE_LOCAL_TTS_HUMAN_SCORE_COLLECTION.md`, `evals/reports/voice_local_tts_human_score_collection_report.md` |
| `voice_local_tts_human_score_entry` | `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-ENTRY-001` | private score entry tool + public aggregate gate, 5 scripts x 6 criteria | private_score_entry_draft_row_count=30, completed_score_row_count=0, aggregate_public_row_count=6, external_provider_call_count=0 | pending_manual_score_entry | human-score-entry-tool-only | `docs/VOICE_LOCAL_TTS_HUMAN_SCORE_ENTRY.md`, `evals/reports/voice_local_tts_human_score_entry_report.md` |
| `voice_local_tts_human_score_entry_completion` | `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-ENTRY-COMPLETION-001` | private score completion verification + public aggregate gate, 5 scripts x 6 criteria | completed_score_row_count=0, pending_score_row_count=30, aggregate_public_row_count=6, external_provider_call_count=0 | blocked_missing_human_scores | human-score-completion-verification-only | `docs/VOICE_LOCAL_TTS_HUMAN_SCORE_ENTRY_COMPLETION.md`, `evals/reports/voice_local_tts_human_score_entry_completion_report.md` |
| `voice_local_tts_human_score_manual_scoring` | `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-MANUAL-SCORING-001` | private HTML score sheet + public aggregate gate, 5 scripts x 6 criteria | private_manual_score_sheet_created_count=1, completed_score_row_count=0, pending_score_row_count=30, external_provider_call_count=0 | ready_for_human_manual_scoring | human-score-manual-workspace-only | `docs/VOICE_LOCAL_TTS_HUMAN_SCORE_MANUAL_SCORING.md`, `evals/reports/voice_local_tts_human_score_manual_scoring_report.md` |
| `voice_local_tts_human_score_manual_scoring_runbook` | `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-MANUAL-SCORING-RUNBOOK-001` | manual scoring runbook readiness, 5 scripts x 6 criteria | private_manual_score_sheet_available_count=1, private_audio_available_count=5, completed_score_row_count=0, pending_score_row_count=30, user_action_required_count=1, external_provider_call_count=0 | ready_for_manual_score_input | manual-scoring-runbook-only | `docs/VOICE_LOCAL_TTS_HUMAN_SCORE_MANUAL_SCORING_RUNBOOK.md`, `evals/reports/voice_local_tts_human_score_manual_scoring_runbook_report.md` |
...
| ---: | --- | --- | --- | --- |
| 1 | `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-MANUAL-SCORE-INPUT-001` | optional human TTS listening score manual score input | private HTML score sheet는 준비됐지만 실제 사람이 청취 후 점수를 입력하지 않았다. | 예 |
...
- `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-FILL-001`에서 5개 script x 6 rubric private score template과 public aggregate runner를 만들었다. completed score count는 0이라 실제 청취 품질 검증 완료 claim은 금지한다.
- `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-COLLECTION-001`에서 private wav 5개 청취 평가 manifest와 guide를 만들었다. completed score count는 0이라 실제 청취 품질 검증 완료 claim은 금지한다.
- `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-ENTRY-001`에서 private score entry guide와 30행 draft를 만들었다. completed score count는 0이라 실제 청취 품질 검증 완료 claim은 금지한다.
- `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-ENTRY-COMPLETION-001`에서 private score 입력 완료 여부를 검증했다. completed score count는 0이라 실제 청취 품질 검증 완료 claim은 금지한다.
- `HD-VOICE-LOCAL-TTS-AUTOMATED-PROXY-EVAL-001`에서 sherpa-onnx TTS wav 5개를 faster-whisper CUDA로 round-trip 전사했고 proxy threshold는 4/5만 통과했다. 이 결과는 사람 청취 점수가 아니며 TTS 후보 채택 차단 상태를 유지한다.
...
| `primary_metric_value` | `private_manual_score_sheet_available_count=1, private_audio_available_count=5, completed_score_row_count=0, pending_score_row_count=30, user_action_required_count=1, external_provider_call_count=0` |
...
결론: 수동 채점 sheet와 5개 wav는 준비됐지만 사람 청취 점수 입력은 0건이다. 이 gate는 점수 생성을 대체하지 않으며, 다음 행동은 사람이 직접 청취하고 30개 rubric score를 private 입력 파일로 저장하는 것이다.
