...
| ---: | --- | --- | --- | --- |
| 1 | `HD-PORTFOLIO-FINAL-PACKAGE-INDEX-001` | portfolio final package index | v2 감사까지 통과했으므로 제출자가 README, final ablation, demo runbook, voice evidence, forbidden claim을 한 화면에서 따라갈 수 있게 묶어야 한다. | 예 |
