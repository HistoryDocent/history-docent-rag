...
| ---: | --- | --- | --- | --- |
| 1 | `HD-VOICE-STT-TTS-PROVIDER-BENCH-PLAN-001` | optional voice STT/TTS provider benchmark plan | contract skeleton은 완료됐다. 실제 provider 비교 전에 browser/native, local CUDA, external API 후보의 공식 문서, 비용, 개인정보, live call budget을 고정해야 한다. | 예 |
