...
| ---: | --- | --- | --- | --- |
| 1 | `HD-COLBERT-001B` | ColBERT style late interaction hard subset 실행 승인 | plan-only gate를 통과했지만 실제 retrieval 실행은 별도 승인 후 진행한다. | 예 |
