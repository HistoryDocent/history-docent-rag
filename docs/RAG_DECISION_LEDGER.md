...
| ---: | --- | --- | --- | --- |
| 1 | `HD-VOICE-LOCAL-KOREAN-TTS-ALTERNATIVE-REVIEW-001` | optional Korean TTS alternative review | Piper 공식 voice manifest에 Korean voice가 없고 MeloTTS는 Windows `eunjeon` blocker가 있으므로 sherpa-onnx 등 무료 로컬 한국어 TTS 대안을 먼저 검토한다. | 예 |
