...
| voice TTS | local fallback smoke 완료 | MeloTTS는 Korean synthesis 차단, Piper는 Korean voice 부재, Windows SAPI Korean fallback으로 private wav 5개 생성, external provider call 0 |
...
| ---: | --- | --- | --- | --- |
| 1 | `HD-VOICE-LOCAL-SHERPA-ONNX-SUPERTONIC3-KO-SMOKE-001` | optional sherpa-onnx Supertonic 3 Korean TTS smoke | 무료 로컬 한국어 TTS 대안 검토에서 다음 후보를 하나로 좁혔다. 설치, 모델 다운로드, private wav artifact는 별도 승인 대상이다. | 예 |
