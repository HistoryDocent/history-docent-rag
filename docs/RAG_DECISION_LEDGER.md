...
| ---: | --- | --- | --- | --- |
| 1 | `HD-README-LANDING-POLISH-001` | README landing polish | 최종 index까지 완료됐으므로 README 첫 화면을 채용 담당자가 60초 안에 읽을 수 있도록 짧게 재배치할 수 있다. | 예 |
