...
| ---: | --- | --- | --- | --- |
| 1 | `HD-VOICE-LOCAL-TTS-HUMAN-SCORE-FILL-001` | optional human TTS listening score fill | 자동 metric과 rubric은 준비됐지만 실제 사람 청취 점수는 아직 0건이다. | 예 |
