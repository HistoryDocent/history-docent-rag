...
| ---: | --- | --- | --- | --- |
| 1 | `HD-PORTFOLIO-REHEARSAL-001` | portfolio submission rehearsal | 제출 전 3분 설명, 기각 후보 설명, 금지 claim 회피를 리허설해야 한다. | 예 |
