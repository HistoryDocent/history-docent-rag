...
| voice TTS | local fallback smoke와 sherpa-onnx Korean smoke 완료 | MeloTTS는 Korean synthesis 차단, Piper는 Korean voice 부재, Windows SAPI fallback과 sherpa-onnx Supertonic 3 Korean private wav 5개 smoke를 기록, external provider call 0 |
...
| ---: | --- | --- | --- | --- |
| 1 | `HD-VOICE-LOCAL-TTS-QUALITY-LISTENING-REVIEW-001` | optional TTS quality listening review | sherpa-onnx Supertonic 3 Korean은 실행 가능성을 확인했지만 음질, 발음, 관광 도슨트 톤은 아직 검증하지 않았다. | 예 |
