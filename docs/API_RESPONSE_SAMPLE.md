...
`HD-PORTFOLIO-QA-001`, ColBERT hard subset, voice UI visual QA, portfolio demo runbook은 완료됐다. 다음 작업은 `HD-SUBMISSION-REFRESH-001`이다.

다음 작업은 새 실험이 아니라 제출 직전 public repository audit refresh다. README 링크, demo runbook, screenshot artifact, 금지 claim, public-safe scan을 다시 확인한다.
