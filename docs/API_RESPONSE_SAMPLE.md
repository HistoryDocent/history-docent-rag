...
`HD-PORTFOLIO-QA-001`, ColBERT hard subset, voice UI visual QA, portfolio demo runbook, public repository audit refresh, portfolio rehearsal, voice STT/TTS planning, voice STT/TTS contract skeleton, provider benchmark plan은 완료됐다. 다음 작업 후보는 `HD-VOICE-STT-TTS-PROVIDER-BENCH-READINESS-001`이다.
