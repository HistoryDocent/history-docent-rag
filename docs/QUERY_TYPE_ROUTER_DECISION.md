...
| HD-ROUTER-003 | HD-ROUTER-002 | query type classifier 설계 | classifier input/output contract, fallback policy, public-safe report | Medium | classifier plan/module revert |
