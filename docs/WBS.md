...
| 9.27 | voice STT/TTS local TTS smoke | local TTS smoke runner, docs/report/test | `MeloTTS Korean` 후보를 public-safe script 5개로 검증, external provider call 0 | `실험: 로컬 TTS smoke 추가` |
