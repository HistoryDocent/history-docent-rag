...
| `local_sherpa_onnx_supertonic3_ko` | TTS | 로컬 실행, API 비용 없음 | sherpa-onnx Supertonic 3 Korean 경로가 확인되어 다음 smoke 후보로 선정. 모델 license와 Windows 실행성은 별도 smoke에서 검증 | next local TTS smoke candidate |
